// GetTVOSUpdatesV2.go
// Fetches and displays full tvOS update data using the SOFA v2 feed.
...
func main() {
	fmt.Println("Fetching tvOS updates from v2 API...")
	...
	data, err := c.GetTvOSSofaFeedV2(ctx)
	if err != nil {
		log.Fatalf("Error fetching tvOS updates: %v", err)
	}
