// GetMacOSUpdatesV2.go
// Fetches and displays full macOS update data using the SOFA v2 feed.
...
func main() {
	fmt.Println("Fetching macOS updates from v2 API...")
	...
	data, err := c.GetMacOSSofaFeedV2(ctx)
	if err != nil {
