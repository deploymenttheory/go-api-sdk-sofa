// ExportmacOSUpdatesToJson.go
// Fetches macOS update data using the SOFA v1 feed and exports to JSON file.
...
func main() {
	...
	filename := fmt.Sprintf("macos_updates_%s.json", timestamp)
	...
	fmt.Printf("Successfully exported macOS updates to %s\n", filename)
}
